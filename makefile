all: fasta_bv_concat compute_gda compute_distance_bwt_run compute_distance_gda_run compute_distance compute_distance_sap
...
compute_distance_sap: compute_distance_sap.cpp
		g++ -std=c++11 -fdiagnostics-color=always -g compute_distance_sap.cpp -o compute_distance_sap
